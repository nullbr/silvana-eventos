  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M17.5 0H6.5C2.91 0 0 2.91 0 6.5v11C0 21.09 2.91 24 6.5 24h11c3.59 0 6.5-2.91 6.5-6.5v-11C24 2.91 21.09 0 17.5 0zM12 5.5a6.5 6.5 0 100 13 6.5 6.5 0 000-13zm0 11a4.5 4.5 0 100-9 4.5 4.5 0 000 9zm6.5-10.5a1.5 1.5 0 110 3 1.5 1.5 0 010-3z"
      />
    </svg>
  );
}
